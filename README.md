...
In this challenge we were tasked to find the number of retiring employees per title and find how many out of those retiring employees are eligible to act as mentors for the next generation of Pewlett Hackard employees. The purpose of this analysis was to try and prepare for the upcoming "Silver Tsunami" in which, in a short period, a high number of older employees are retiring leaving open positions and lesser workforce. This could have advere effects if not dealt with properly or promptly as the company would be tasked to find a huge number of replacements in a very short time. 
